      ...
      <div className="relative  grid grid-cols-1 lg:grid-cols-2 gap-8  bg-opacity-80  rounded-lg w-full  text-gray-800">
        ...
        {/* Text Content */}
              <div className=" py-6  flex flex-col ">
                         {/* Contact Heading */}
        <h2 className="relative text-4xl leading-none lg:text-7xl font-bold text-gray-300 mb-10">Let's <br /><span className='text-indigo-400'>Collaborate!</span></h2>
          <h2 className="text-3xl font-semibold mb-4 text-gray-300">I'd Love to Hear From You!</h2>
