...
function Work() {
  ...
  return (
      <section className="pt-36 pb-20 px-3 lg:p-36 min-h-dvh bg-black">
          <h2 className="text-5xl leading-none lg:text-7xl font-bold text-gray-300 mt-5  mb-20">Check out <br className='block md:hidden' /><span className='text-indigo-500'>my Portfolio</span></h2>
